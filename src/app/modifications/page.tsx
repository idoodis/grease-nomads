  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(`Thanks, ${name}! We'll reach out to discuss your modification consultation.`);
        setFormData({
          name: '',
          email: '',
          phone: '',
      ...
      >
        ...
        <main>
          ...
          <section id="contact" style={{ maxWidth: '1100px', margin: '0 auto', padding: '0 1.25rem 2.5rem' }}>
            <h2 style={{ fontSize: 'clamp(1.2rem,1.5vw+0.6rem,1.8rem)', margin: '1.6rem 0 .6rem' }}>
              Request a Modification Consultation
            </h2>
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ display: 'grid', gap: '.35rem', marginTop: '.8rem' }}>
                <label htmlFor="message">Desired Modifications</label>
                <textarea
                  id="message"
                  name="message"
                  rows={5}
                  placeholder="Describe the modifications you're looking for"
            ...
            <p style={{ color: '#c9c9c9', marginTop: '.6rem' }}>
              Please Contact Us for a Free Consultation. <br />
